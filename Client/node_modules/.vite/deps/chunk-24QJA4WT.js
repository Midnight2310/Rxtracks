import {
  ...
  useTheme,
  useThemeProps
} from "./chunk-C4DRK7LA.js";
import {
  _objectWithoutPropertiesLoose,
  require_prop_types
} from "./chunk-IKNNIKAZ.js";
import {
  require_jsx_runtime
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React13.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React14.useContext(SvgContext);
  const {
    width,
    height,
    top: top2,
...
var ChartsSurface = React15.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React21.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React35.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
//# sourceMappingURL=chunk-24QJA4WT.js.map
