...
const AddOutput = () => {
  ...
  const handleMedNameChange = (value) => {
    ...
    if (value !== "") {
      ...
      if (selectedMedicine) {
        ...
        setMedLocation(selectedMedicine.location_id);
  ...
  return (
    <div>
      <Topic topicTitle="เบิกจ่ายยา" description="เบิกจ่ายยา, ออกใบเบิก" />
      <form
        className="m-5 p-5 "
        style={{
        ...
        <div className="row mb-3">
          ...
          <div className="form-group col-4">
            ...
            >
              ...
              <option value="1 - Patient Patient">1 - Patient Patient</option>
            </select>
          </div>
      ...
      >
        ...
        <Modal.Body>คุณต้องการเบิกยานี้ใช่หรือไม่</Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={() => {
